    ...
    return popularMovies.map((movie, i) => {
      return (
          <div className="Movie-wrapper" key={i}>
              ...
              <div className="Movie-raterat">Rating :  </div><div className="Movie-rate"> {movie.vote_average}</div>
            </div>
      )
    })
  }
    ...
    <div className="App">
      <header className="App-header">
          <div className="Top-nav">
            <a className="Home-page" href="">Homepage</a>
            <a className="Top-rated" href="">Top-Rated</a>
